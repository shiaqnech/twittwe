        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3 mt-4"><img
                                ...
                                alt="..." width="200" height="100" class="rounded mb-2 img-thumbnail"><a href="editProfile.php"
                                                                                            class="btn btn-outline-dark btn-sm btn-block float-end">Edita
                            perfil</a><a href="newPost.php"
                                         class="btn btn-outline-dark btn-sm btn-block float-end me-3">Afegeix un nou
                            post</a></div>
                ...
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">
                            <?php if (empty($_SESSION['login'][2]->getPosts())) { ?>
                                0
                            <?php } else {
                                echo sizeof($_SESSION['login'][2]->getPosts()) ?>
                            <?php } ?>
                        </h5><small class="text-muted"> <i class="fas fa-image mr-1"></i>Posts</small>
                    </li>
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">
                            <?php if (empty($_SESSION['login'][2]->getFollowers())) { ?>
                                0
                            <?php } else { ?>
                            <?php } ?>
                    ...
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">
                            <?php if (empty($_SESSION['login'][2]->getFollowed())) { ?>
                                0
                            <?php } else {
                                echo sisizeof($_SESSION['login'][2]->getPosts()) ?>
                                21
                            <?php } ?>
            ...
            <div class="py-4 px-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <?php } else { ?>
                        <?php foreach ($_SESSION['login'][2]->getPosts() as $post) {;?>
