                ...
                <div class="px-4 py-3">
                    <table class="table table-dark table-hover">
                        ...
                        <?php foreach ($_SESSION['users'] as $user) { ?>
                            <?php if ($user->getUsername() != $_SESSION['login'][2]->getUsername()) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action='../controllers/listUserPosts.php' method='post'>
                                            <input type='hidden' name='username' value='<?php echo $user->getUsername()?>''>
                                            <button type='submit' class='btn btn-secondary'>Mirar posts</button>
                                        </form>
                                    </td>
                                    <td>
                                        <form action='../controllers/loadEditUserProfile.php' method='post'>
                                            <input type='hidden' name='username' value='<?php echo $user->getUsername()?>'>
                                            <button type='submit' class='btn btn-secondary'>Edita Usuari</button>
                                        </form>
                                    </td>
                                    <td>
...
<!--<td><a href="../controllers/listUserPosts.php" class="btn btn-secondary">Perfil</a></td>-->
<!--<td><a href="" class="btn btn-secondary">Mostra posts</a></td>-->
<!--<td><a class="btn btn-secondary">Edita</a></td>-->
<!--<td><a class="btn btn-danger">Elimina</a></td>
