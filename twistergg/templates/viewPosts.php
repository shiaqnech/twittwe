...
<div class="row py-5 px-4">
    <div class="col-md-5 mx-auto">
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <h2 class="mt-3 text-center">Posts de l'usuari <?php echo $_SESSION['user']->getUsername()?></h2>
                ...
                <?php foreach ($_SESSION['user']->getPosts() as $post){?>
                    <div class="px-4 py-3 mb-4">
                        <div class="p-4 rounded shadow-sm bg-light">
                            ...
                            <div >
                                <form action='../controllers/deletePostAdminController.php' method='post'>
                                    ...
                                    <p class="float-end mt-2"><?php echo $post->getDate()->format('d-m-y h:i') ?></p>
                                </form>
                            </div>
                        </div>
                    </div>
