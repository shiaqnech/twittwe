                ...
                <?php if(empty($_SESSION['posts'])){?>
                    <div class="px-4 py-3">
                        <div class="p-4 rounded shadow-sm bg-light">
                            Encara no s'ha publicat cap post
                        </div>
                    </div>
                <?php }else{ ?>
                <?php foreach ($_SESSION['posts'] as $post){?>
                    <div class="px-4 py-3 mb-4">
                        <div class="p-4 rounded shadow-sm bg-light">
                            ...
                            <div class="mb-3">
                                <div class="border border-primary text-center justify-content-center align-items-center" style="width:20%; margin-top: 2%">
                                    <img src="../static/avatars/<?php echo $post->getUser()->getAvatar()?>" height="50"  width="60" alt="" style="margin-top: 10%">
                                    <p class=""><?php echo $post->getUser()->getUsername()?></p>
                                </div>
                                <p class="float-end"><?php echo $post->getDate()->format('d-m-y h:i') ?></p>
                            </div>
                        </div>
                    </div>
                <?php } ?>
